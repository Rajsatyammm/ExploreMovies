	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="assets/img/bhrmfullhd.jpg" alt="First slide">
				<div class="jumbotron">
					<div class="container">
						<div class="carousel-caption">
							<h1>REVIEWS</h1>
							<p>Welcome to the Movie Review and Download Services!</p>
						</div>
					</div>
				</div>
			</div>
			<div class="item">
				<img src="assets/img/EkVillianpos.jpg" alt="Second slide">
				<div class="jumbotron">
					<div class="container">
						<div class="carousel-caption">
							<h1>Rate Movies</h1>
			...
			<div class="item">
				<img src="assets/img/war.jpg" alt="Third slide">
				<div class="jumbotron">
					<div class="container">
						<div class="carousel-caption">
							<h1>Read Reviews</h1>
